options(shiny.maxRequestSize=30*1024^2) # change default upload size to 30MB
...
enrichRdbs <- as.character(read.csv(paste0(getwd(),"/www/enrichRdbs.csv"))[,1])
